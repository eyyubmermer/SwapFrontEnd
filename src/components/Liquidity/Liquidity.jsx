        ...
        return (
            <div className={style.containerswap} >
                ...
                <div className={style.result}>
                    <div>
                        <button className={`${style.custombtnn} ${style.btnn}`}>Approve {this.state.input_currency}</button>
                        <button className={`${style.custombtnn} ${style.btnn}`}>Approve {this.state.output_currency}</button>
                    </div>
